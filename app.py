...
with st.sidebar:
    ...
    st.markdown(
        """
        <div style="background-color:#1e1e1e; color: #ffffff; padding:15px; border-radius:10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
            <h4 style="color:#4A90E2; text-align:center;">👨‍💻 About the Developer 👩‍💻</h4>
            <p style="font-size:14px; text-align: center">
                Made with ❤️ by Muhammad Anas Jamshaid<br>
                Building secure apps, one password at a time! 🚀
            </p>
        </div>
        """,
        unsafe_allow_html=True,
...
# Password Input
password = st.text_input("Enter Your Password", type="password", help="Enter your password and press Enter to check its strength.") # Adding the Help Text
...
st.markdown("""
    <hr>
    <p style='text-align: center;'>Developed with ❤️ by Muhammad Anas</p>
""", unsafe_allow_html=True)